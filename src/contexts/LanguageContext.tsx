...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'nav.contact': 'Contact',
    'hero.title': 'Crafting Sound. Emotion.',
    'hero.subtitle': 'Mixing, Mastering, and Recording',
    'about.label': '01 // ABOUT',
    'about.title': 'The Intersection of Art and Science',
    'about.desc': 'I specialize in mixing, mastering, and recording. I blend technical precision with musical intuition to bring your sonic vision to life.',
  ...
  ko: {
    ...
    'nav.contact': '연락처',
    'hero.title': '  ',
    'hero.subtitle': '믹싱, 마스터링, 레코딩',
    'about.label': '01 // 소개',
    'about.title': '예술과 공학의 교차점',
    'about.desc': '믹싱, 마스터링, 레코딩을 전문으로 합니다. 기술적인 정밀함과 음악적인 직관을 결합하여 당신의 사운드 비전을 현실로 만듭니다.',
